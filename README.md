...
> **Status:** ✅ Complete — SQL Warehouse + Power BI Dashboard
...
An interactive 4-page Power BI dashboard built on top of the Gold layer, connecting directly to SQL Server via Windows Authentication.

### Page 1 — Patient Overview
![Patient Overview](docs/images/Patient%20Overview.png)

### Page 2 — Encounter Activity
![Encounter Activity](docs/images/Encounter%20Activity.png)

### Page 3 — Clinical Insights
![Clinical Insights](docs/images/Clinical%20Insights.png)

### Page 4 — Provider & Payer
![Provider & Payer](docs/images/Provider%20%26%20Payer.png)

---

## 🗺️ Silver Layer — Entity Relationship Diagram

The Silver layer ERD shows all 16 tables with their key relationships. `encounters` is the central hub — nearly all clinical event tables link to it via foreign keys.
...
│       ├── Patient Overview.png        # Power BI dashboard — Page 1
│       ├── Encounter Activity.png      # Power BI dashboard — Page 2
│       ├── Clinical Insights.png       # Power BI dashboard — Page 3
│       └── Provider & Payer.png        # Power BI dashboard — Page 4
│
├── scripts/                            # SQL scripts
...
[GitHub](https://github.com/Ddevedza) · [LinkedIn](https://www.linkedin.com/in/dusan-devedzic/)
